...
app.use('/upload', fileUpload({ createParentPath: true }), filesPayloadExists, fileExtLimiter(['.png', '.jpg', '.pdf', '.doc', '.xlsx']), fileSizeLimiter, require('./routes/uploadFilesRoutes'))
app.use('/files', require('./routes/filesRoutes'))
// app.use('/getfiles', require('./routes/filesRoutes'))
